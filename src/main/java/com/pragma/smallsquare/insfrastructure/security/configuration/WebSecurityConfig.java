...
//                        "/small-square/dish/restaurant/{idRestaurant}/category/{idCategory}/list**",
                ...
                .antMatchers(HttpMethod.GET, "/small-square/dish/{id}").hasRole(RoleEnum.OWNER.getName())
                .antMatchers(HttpMethod.PUT, "/small-square/dish/status/{id}").hasRole(RoleEnum.OWNER.getName())
